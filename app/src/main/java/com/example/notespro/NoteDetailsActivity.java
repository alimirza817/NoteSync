...
public class NoteDetailsActivity extends AppCompatActivity {
    ...
    void saveNoteToFirebase(Note note) {
        ...
        if (documentReference != null) {
            ...
            // Handle the case where documentReference is null (if it should not be null)
            Utility.showToast(NoteDetailsActivity.this, "Error: documentReference is null");
        }
    }

    void deleteNoteFromFirebase() {
        if (docId != null && !docId.isEmpty()) {
            DocumentReference documentReference = Objects.requireNonNull(Utility.getCollectionReferenceForNotes()).document(docId);
